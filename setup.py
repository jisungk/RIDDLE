...
'RIDDLE uses Keras to specify, train, and build the underlying DL models. It was debugged using Keras with a TensorFlow backend. The default architecture is a deep multi-layer perceptron (deep MLP) that takes “one-hot-encoded” features. However, you can specify any DL architecture (e.g., LSTM, CNN) by writing your own model_module files! '
...
setup(
    ...
    url='https://riddle.ai',
    license='Apache 2.0',
    download_url='https://github.com/jisungk/riddle/tarball/2.0.0',
    license='-',
